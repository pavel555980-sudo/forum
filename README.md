...
v1.2:
<ul>
<li>Реализация личных сообщений</li>
<li>Реализация функционала для модераторов(взаимодействие с пользователями, ветками, сообщениями)</li>
<li>Реализация системы рейтинга и ролей</li>
</ul>
<br>
v1.3:
<ul>
<li>Реализация сервиса автомодерации</li>
<li>Реализация 2FA</li>
<li>Косметические изменения</li>
</ul>
<br>
Доп. фичи:
